...
export function MarksheetPrintableView({ data }: MarksheetPrintableViewProps) {
  ...
  return (
    <div
      className="mx-auto bg-[#fffdf5] text-[#111111] p-[4mm_8mm_4mm_8mm] border-[2px] border-[#14206b] relative shadow-lg print:shadow-none print:m-0 print:border-[1.5px] font-serif box-border select-none print:w-full print:max-w-[280mm]"
      style={{
        width: "280mm",
        minHeight: "184mm",
      }}
    >
      ...
      <div className="relative z-10 flex flex-col justify-center min-h-[175mm]">
        {/* TOP HEADER */}
        <div>
          ...
          <div className="flex justify-between items-baseline text-[11.5px] my-1.5 px-1 gap-3 font-serif">
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="font-bold border-b border-[#111] px-2 text-center min-w-[40px] text-[12px] text-neutral-900">
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="font-bold border-b border-[#111] px-2 text-center min-w-[32px] text-[12px] text-neutral-900">
                {data.section || "A"}
              </span>
            </div>
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="font-bold border-b border-[#111] px-2 text-center min-w-[40px] text-[12px] text-neutral-900 font-mono">
                {data.rollNo || "01"}
              </span>
            </div>
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="font-bold border-b border-[#111] px-2 text-center min-w-[120px] text-[12px] text-neutral-900 font-mono">
        ...
        <table className="w-full border-collapse border border-[#14206b] my-1 text-[9.5px]">
          <thead>
            ...
            <tr className="bg-[#14206b] text-white text-center font-bold">
              <th rowSpan={2} className="border border-[#14206b] p-1 text-left pl-2.5 font-serif text-[10.5px] w-[14%]">
                Subject
              </th>
              <th colSpan={3} className="border border-[#14206b] p-1 text-[10px] w-[19%]">
              ...
              <th colSpan={3} className="border border-[#14206b] p-1 text-[10px] w-[21%]">
                Overall Marks &amp; Grade
              </th>
              <th rowSpan={2} className="border border-[#14206b] p-1 text-[9px] w-[8%]">
            ...
            <tr className="bg-[#eef0f8] text-[#14206b] text-center font-bold text-[9px]">
              {/* 1st Term */}
              <th className="border border-[#14206b] p-0.5">Periodic</th>
              <th className="border border-[#14206b] p-0.5">Preparatory</th>
              <th className="border border-[#14206b] p-0.5 text-[#14206b]">Total</th>
              ...
              {/* Overall */}
              <th className="border border-[#14206b] p-0.5">Total</th>
              <th className="border border-[#14206b] p-0.5">Percentage</th>
              <th className="border border-[#14206b] p-0.5">Grade</th>
            </tr>

            {/* Row 3: Max Marks */}
            <tr className="bg-slate-100 text-[#14206b] text-center font-bold text-[8.5px] font-mono">
              <th className="border border-[#14206b] p-0.5 text-left pl-2.5 font-serif font-normal italic text-neutral-600">
                Full Marks &rarr;
              </th>
          ...
          <tbody className="text-center font-sans text-[10px]">
            {data.subjects.map((sub, idx) => (
              ...
              >
                ...
                <td className="border border-[#14206b] py-[2px]">{sub.term1.periodic}</td>
                <td className="border border-[#14206b] py-[2px]">{sub.term1.preparatory}</td>
                <td className="border border-[#14206b] py-[2px] font-bold text-[#14206b] bg-[#14206b]/5">{sub.term1.total}</td>
                <td className="border border-[#14206b] py-[2px]">{sub.term2.periodic}</td>
                <td className="border border-[#14206b] py-[2px]">{sub.term2.preparatory}</td>
                <td className="border border-[#14206b] py-[2px] font-bold text-[#14206b] bg-[#14206b]/5">{sub.term2.total}</td>
                <td className="border border-[#14206b] py-[2px]">{sub.term3.periodic}</td>
                <td className="border border-[#14206b] py-[2px]">{sub.term3.preparatory}</td>
                <td className="border border-[#14206b] py-[2px] font-bold text-[#14206b] bg-[#14206b]/5">{sub.term3.total}</td>
                <td className="border border-[#14206b] py-[2px] font-extrabold text-[#14206b] bg-[#eef0f8]/50">{sub.overallTotal}</td>
                <td className="border border-[#14206b] py-[2px] font-semibold text-neutral-800">{sub.percentage}%</td>
                <td className="border border-[#14206b] py-[2px] font-extrabold text-[#14206b]">{sub.grade}</td>
                <td className="border border-[#14206b] py-[2px] font-mono">{sub.highestMarksInClass}</td>
              </tr>
            ))}
            {/* GRAND TOTAL ROW */}
        ...
        {(() => {
          ...
          return (
            <div className="flex justify-between items-end gap-2.5 mt-3 pt-1 border-t border-[#14206b]/20">
              <div className="w-[14.5%] h-[126px] flex flex-col justify-end text-center pb-0.5">
              ...
              <div className="w-[15%] h-[126px] flex flex-col justify-end text-center pb-0.5">
                <div className="h-[52px]" />
                <div className="border-t-[1.5px] border-[#111] pt-1">
                  <div className="text-[10px] font-bold text-neutral-800 leading-tight font-serif">
              ...
              <div className="w-[18.5%] h-[126px] flex flex-col items-center justify-end text-center pb-0.5">
                <div className="h-[52px] flex items-end justify-center mb-0.5">
                  <img
                    src="/hod-signature.png"
                    alt="Teacher-in-Charge Signature"
                    className="max-h-[42px] max-w-[135px] object-contain mix-blend-multiply"
                  />
                </div>
              ...
              <div className="w-[24%] h-[126px] border-[1.5px] border-[#14206b] rounded-xs bg-amber-50/70 p-1 flex flex-col justify-between text-center shadow-xs">
                <div>
              ...
              <div className="w-[26%] h-[126px] border border-[#14206b] rounded-xs bg-white overflow-hidden flex flex-col justify-between">
                <table className="w-full border-collapse text-[7.5px] h-full">
                  ...
                  <tbody className="font-sans">
                    {WBBSE_GRADE_SCALE.map((g, idx) => (
                      ...
                      >
                        <td className="py-[0.8px] px-1 pl-1.5 text-left font-mono text-[7.5px]">{g.range}</td>
                        <td className="py-[0.8px] px-0.5 text-center font-extrabold text-[#14206b] text-[8.5px]">{g.grade}</td>
                        <td className="py-[0.8px] px-1 text-left text-neutral-700 text-[7.5px]">{g.remarks}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
