...
export function MarksheetPrintableView({ data }: MarksheetPrintableViewProps) {
  ...
  return (
    <div
      ...
      className="mx-auto bg-[#fffdf5] text-[#111111] p-[3mm_6mm_3.5mm_6mm] border-[2.5px] border-[#14206b] relative shadow-2xl print:shadow-none print:m-0 print:border-[2px] font-serif box-border select-none print:w-full print:max-w-[286mm]"
      style={{
        width: "286mm",
        height: "196mm",
        minHeight: "196mm",
      ...
      <div className="relative z-10 flex flex-col justify-between h-full">
        ...
        <div>
          ...
          <div className="text-center py-0">
            <h2 className="text-[13px] sm:text-[14px] font-extrabold tracking-wider text-[#14206b] uppercase underline underline-offset-4 decoration-[#14206b] inline-block font-serif">
              Continuous &amp; Comprehensive Evaluation &ndash; {data.academicYear || "2026"}
            </h2>
            <div className="text-[9px] italic text-neutral-600 font-sans mt-0.5 font-medium">
              Annual Academic Progress Report Card
            </div>
          </div>

          {/* Student Info Strip (Clean 4-Item Format: Name, Class, Roll No, Student ID) */}
          <div className="flex justify-between items-baseline text-[11.5px] my-1 px-1 gap-4 font-serif">
            <div className="flex items-baseline gap-1.5 min-w-[320px] flex-1">
              ...
              <span className="font-extrabold border-b border-[#111] px-2 flex-1 text-left text-[12.5px] text-neutral-900 uppercase">
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="font-extrabold border-b border-[#111] px-3 text-center min-w-[50px] text-[12px] text-neutral-900">
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="font-extrabold border-b border-[#111] px-3 text-center min-w-[50px] text-[12px] text-neutral-900 font-mono">
                {data.rollNo || "01"}
              </span>
            </div>
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="font-extrabold border-b border-[#111] px-3 text-center min-w-[130px] text-[11.5px] text-neutral-900 font-mono">
        ...
        {/* =================================================================== */}
        <table className="w-full border-collapse border border-[#14206b] my-0.5 text-[9.2px]">
          <thead>
            {/* Row 1: Term Group Headers */}
            <tr className="bg-[#14206b] text-white text-center font-bold">
              <th rowSpan={2} className="border border-[#14206b] py-1 px-1 text-left pl-2.5 font-serif text-[10px] w-[14%]">
                Subject
              </th>
              <th colSpan={3} className="border border-[#14206b] py-0.5 px-1 text-[9.5px] w-[19%]">
              ...
              <th colSpan={3} className="border border-[#14206b] py-0.5 px-1 text-[9.5px] w-[21%]">
                Overall Marks &amp; Grade
              </th>
              <th rowSpan={2} className="border border-[#14206b] py-0.5 px-1 text-[8.5px] w-[8%]">
                Highest Marks<br />in Class
              </th>
            </tr>

            {/* Row 2: Sub-headers */}
            <tr className="bg-[#eef0f8] text-[#14206b] text-center font-bold text-[8.5px]">
              {/* 1st Term */}
            ...
            {/* Row 3: Max Marks */}
            <tr className="bg-slate-100 text-[#14206b] text-center font-bold text-[8px] font-mono">
          ...
          <tbody className={`text-center font-sans ${tbodyFontSize}`}>
            ...
            <tr className="bg-[#eef0f8] font-bold text-[#14206b] border-t-2 border-[#14206b]">
              <td colSpan={10} className="border border-[#14206b] text-right pr-3 py-0.5 font-serif text-[10.5px]">
                Grand Total (Out of {totals.maxPossibleMarks}) &ndash;
              </td>
              <td className="border border-[#14206b] py-0.5 font-extrabold text-[10.5px] bg-[#14206b] text-white font-mono">
                {totals.totalMarksObtained}
              </td>
              <td className="border border-[#14206b] py-0.5 font-extrabold text-[10px] text-[#14206b] font-mono">
                {totals.overallPercentage}%
              </td>
              <td className={`border border-[#14206b] py-0.5 font-extrabold text-[11px] ${
              ...
              <td className="border border-[#14206b] py-0.5 text-neutral-700 font-mono text-[9.5px]">
            ...
            <div className="flex justify-between items-end gap-2 mt-1 pt-1 border-t border-[#14206b]/20">
              ...
              <div className="w-[14.5%] h-[114px] flex flex-col justify-end text-center pb-0.5">
                ...
                <div className="border-t-[1.5px] border-[#111] pt-1">
                  <div className="text-[9.5px] font-bold text-neutral-800 leading-tight font-serif">
                    Signature of Guardian
                  </div>
                  <div className="text-[7.5px] text-neutral-500 font-sans mt-0.5">
                    Date: ........................
                  </div>
                </div>
              </div>
              ...
              <div className={`w-[24%] h-[114px] border-[1.5px] rounded-xs p-1 flex flex-col justify-between text-center shadow-xs ${
                isFailing
                  ? "border-red-600 bg-red-50/70"
                  : "border-[#14206b] bg-amber-50/70"
              }`}>
                <div>
                  <div className="text-[7.5px] uppercase tracking-wider text-neutral-600 font-sans font-bold">
                    Promotion Status
                  </div>
                  <div className={`text-[10.5px] font-black tracking-wide leading-tight my-0.5 ${
                ...
                {isFailing ? (
                  <div className="my-0.5 py-0.5 px-1 bg-red-100 border border-red-400 rounded shadow-xs">
                    <div className="text-[7px] font-bold uppercase tracking-wider text-red-900">
                      Academic Evaluation
                    </div>
                    <div className="text-[10.5px] font-black font-mono text-red-800 leading-tight">
                      GRADE: D (FAIL)
                    </div>
                    <div className="text-[6.5px] font-semibold text-red-700 tracking-tight">
                  ...
                  rankNum === 1 ? (
                    <div className="my-0.5 py-0.5 px-1 bg-gradient-to-r from-amber-200 via-amber-100 to-amber-200 border border-amber-600 rounded shadow-xs">
                      <div className="text-[7px] font-black uppercase tracking-wider text-amber-950 flex items-center justify-center gap-1">
                        <span>&#9733;</span>
                        <span>CLASS TOPPER</span>
                        <span>&#9733;</span>
                      </div>
                      <div className="text-[11px] font-black font-mono text-[#14206b] leading-tight my-0.5">
                        RANK: 1st
                      </div>
                      <div className="text-[6.5px] font-bold text-amber-900 tracking-tight">
                        ACADEMIC EXCELLENCE
                      </div>
                    </div>
                  ) : rankNum === 2 ? (
                    <div className="my-0.5 py-0.5 px-1 bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 border border-slate-500 rounded shadow-xs">
                      <div className="text-[7px] font-black uppercase tracking-wider text-slate-900 flex items-center justify-center gap-1">
                        <span>&#9733;</span>
                      ...
                      <div className="text-[6.5px] font-bold text-slate-700 tracking-tight">
                    ...
                    <div className="my-0.5 py-0.5 px-1 bg-gradient-to-r from-[#14206b]/15 via-[#14206b]/5 to-[#14206b]/15 border border-[#14206b]/40 rounded shadow-xs">
                      <div className="text-[7px] font-black uppercase tracking-wider text-[#14206b] flex items-center justify-center gap-1">
                        <span>&#9733;</span>
                        <span>TOP 10 HONORS</span>
                        <span>&#9733;</span>
                      </div>
                      <div className="text-[10.5px] font-black font-mono text-[#14206b] leading-tight my-0.5">
                        RANK: {formattedRank}
                      </div>
                      <div className="text-[6.5px] font-bold text-neutral-600 tracking-tight">
                        MERIT ROLL HOLDER
                      </div>
                    </div>
                  )
                  ...
                  <div className="my-0.5 py-0.5 px-1 bg-slate-100 border border-slate-300 rounded">
                    <div className="text-[7px] font-bold uppercase tracking-wider text-neutral-500">
                      Class Position
                    </div>
                    <div className="text-[10.5px] font-extrabold font-mono text-[#14206b] leading-tight">
                      RANK: {formattedRank}
                    </div>
                  </div>
                )}

                <div className="text-[7px] text-neutral-600 font-sans">
              ...
              <div className="w-[26%] h-[114px] border border-[#14206b] rounded-xs bg-white overflow-hidden flex flex-col justify-between shadow-2xs">
                <table className="w-full border-collapse text-[7px] h-full">
                  <thead>
                    <tr className="bg-[#14206b] text-white text-center font-bold">
                      <th colSpan={3} className="py-[1px] text-[8px] tracking-wide font-sans">
                        Scale of Evaluation &ndash; WBBSE
                      </th>
                    </tr>
                    <tr className="bg-[#eef0f8] text-[#14206b] font-bold text-center border-b border-[#14206b] text-[7px]">
                      <th className="py-[0.5px] px-1 text-left pl-1.5">Range of Marks</th>
                      <th className="py-[0.5px] px-0.5">Grade</th>
                      <th className="py-[0.5px] px-1 text-left">Remarks</th>
                    </tr>
                  </thead>
                  <tbody className="font-sans">
                    {WBBSE_GRADE_SCALE.map((g, idx) => {
                      ...
                      return (
                        ...
                        >
                          <td className="py-[0.5px] px-1 pl-1.5 text-left font-mono text-[7px] font-semibold">
                            {g.range}
                          </td>
                          <td className={`py-[0.5px] px-0.5 text-center font-black text-[7.5px] ${
                            isFailRow ? "text-red-700" : "text-[#14206b]"
                          }`}>
                            {g.grade}
                          </td>
                          <td className={`py-[0.5px] px-1 text-left text-[7px] ${
