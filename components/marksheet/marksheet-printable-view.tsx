...
export function MarksheetPrintableView({ data }: MarksheetPrintableViewProps) {
  ...
  return (
    <div
      className="mx-auto bg-[#fffdf5] text-[#111111] p-[5mm_8mm_5mm_8mm] border-[2px] border-[#14206b] relative shadow-lg print:shadow-none print:m-0 print:border-[1.5px] font-serif box-border select-none print:w-full print:h-[196mm] print:max-h-[196mm] print:p-[5mm_8mm_5mm_8mm] flex flex-col justify-between"
      style={{
        width: "284mm",
        height: "196mm",
        minHeight: "196mm",
      ...
      <div className="relative z-10 flex flex-col justify-between h-full">
        ...
        <div>
          <div className="flex items-start justify-between gap-3">
            {/* School Logo */}
            <div className="shrink-0 w-[74px] text-center pt-0.5">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/school-logo.png"
                alt="School Logo"
                className="w-[70px] h-[70px] object-contain mx-auto drop-shadow-xs"
              />
            </div>
            ...
            <div className="shrink-0 w-[110px] text-right text-[11px] italic pt-0.5 space-y-0.5">
          ...
          <div className="flex justify-between items-baseline text-[12px] my-2 px-1 gap-3 font-serif">
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="font-bold border-b border-[#111] px-2 min-w-[42px] text-center text-[12.5px]">
        ...
        <div className="my-1 overflow-hidden flex-1 flex flex-col justify-center">
