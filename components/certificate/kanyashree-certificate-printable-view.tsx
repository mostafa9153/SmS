...
export function KanyashreeCertificatePrintableView({
  ...
  const qrPayload = `MHS-KP:${data.certificateNo || "KP-2026"}|ID:${data.studentId || "N/A"}|NAME:${data.studentName || ""}|CLASS:${data.presentClass || ""}`;
            ...
            {(() => {
              ...
              return (
                <div className="text-center flex-1 space-y-0.5 min-w-0">
                  <h1 className="text-[16px] sm:text-[17px] font-black tracking-normal uppercase text-[#9333ea] font-serif leading-tight whitespace-nowrap">
                    {mainName}{suffix ? ` ${suffix}` : ""}
                  </h1>
                  <div className="uppercase leading-none whitespace-nowrap font-serif font-bold text-[#9333ea] tracking-wider text-[9.5px]">
                    (Co-Educational)
                  </div>
