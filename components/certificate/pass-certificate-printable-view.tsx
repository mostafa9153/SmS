...
export function PassCertificatePrintableView({ data, schoolProfile }: PassCertificatePrintableViewProps) {
  ...
  const qrPayload = `MHS-PASS:${data.certificateNo || "PASS-2026"}|ID:${data.studentId || "N/A"}|NAME:${data.studentName || ""}|YEAR:${data.passingYear || "2026"}`;
            ...
            {(() => {
              ...
              return (
                <div className="text-center flex-1 space-y-0.5 min-w-0">
                  <h1 className="text-[16px] sm:text-[17px] font-black tracking-normal uppercase text-[#0f766e] font-serif leading-tight whitespace-nowrap">
                    {mainName}{suffix ? ` ${suffix}` : ""}
                  </h1>
                  <div className="uppercase leading-none whitespace-nowrap font-serif font-bold text-[#0f766e] tracking-wider text-[9.5px]">
                    (Co-Educational)
                  </div>
