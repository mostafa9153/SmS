    ...
    <div className="admission-form-document text-black font-sans leading-normal print:w-full print:m-0 print:p-0">
      ...
      {(activePage === "all" || activePage === "page1") && (
        <div
          id="admission-page-1"
          className={cn(
            "admission-sheet relative bg-white mx-auto box-border flex flex-col justify-between border-2 border-black overflow-hidden",
            activePage === "all" ? "page-break-after-sheet" : "no-page-break-after"
          )}
          style={{
            width: "205mm",
            minHeight: "291mm",
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0 overflow-hidden select-none">
            <img
              ...
              className="w-[360px] h-[360px] object-contain opacity-[0.06] grayscale pointer-events-none"
            />
          </div>
          ...
          <div className="w-full relative z-10">
            ...
            <div className="border-b-2 border-black pb-2 mb-2">
              <div className="grid grid-cols-[100px_1fr_120px] items-center gap-2">
                ...
                <div className="text-center px-1">
                  <h1 className="text-[24px] font-black uppercase tracking-tight text-black font-serif leading-tight">
                    {school.name}
                  </h1>
                  <p className="text-[12.5px] font-bold leading-tight mt-1 text-gray-950">
                    {school.address}
                  </p>
                  <p className="text-[12px] font-bold leading-tight text-gray-950">
                ...
                {/* 3. Right: Form No Badge (Compact & High Contrast) */}
                <div className="flex items-center justify-end">
                  <div className="border-2 border-black bg-gray-50 px-2.5 py-1 text-[11.5px] font-bold font-mono tracking-tight text-right whitespace-nowrap shadow-xs">
                    {displayFormNo}
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-stretch justify-between gap-4 mb-2">
              {/* Photo Box (3:4 aspect ratio: 35mm x 45mm) */}
              <div
              ...
              {/* For Office Use Box (50mm x 45mm) */}
              <div
                className="border-2 border-black p-2 text-[12px] leading-tight bg-gray-50/30 shrink-0 flex flex-col justify-between"
                style={{ width: "50mm", height: "45mm" }}
              >
          ...
          {/* Body Section */}
          <div className="w-full space-y-3 text-[12.5px]">
            {/* A. Basic Information */}
            <div>
              <div className="font-black text-[13.5px] uppercase bg-gray-100 border-2 border-black px-3 py-0.5 mb-1.5 flex items-center">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 h-[34px] border-2 border-black px-3 flex items-center font-black text-[14px] uppercase tracking-wide bg-white">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 h-[34px] border-2 border-black px-3 flex items-center font-bold text-[14px] bg-white">
              ...
              <div className="grid grid-cols-12 gap-4 mt-1.5 items-center">
                <div className="col-span-5 flex items-center gap-2">
                  <span className="font-bold text-[12.5px] shrink-0">3. DOB:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-mono font-black text-[13.5px] tracking-widest bg-white">
                ...
                <div className="col-span-7 flex items-center gap-2">
                  ...
                  <div className="flex-1 h-[34px] border-2 border-black px-3 flex items-center font-bold text-[13px] bg-white">
              ...
              <div className="grid grid-cols-2 gap-6 mt-1.5 items-center">
                <div className="flex items-center gap-2">
                  <span className="font-bold text-[12.5px] w-[135px] shrink-0">6. Social Category*:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-3 flex items-center font-bold text-[12.5px] bg-white">
              ...
              <div className="mt-1.5 flex items-center gap-2">
                <span className="font-bold text-[12.5px] w-[120px] shrink-0">10. Aadhaar No:</span>
                <div className="flex items-center">
                  {aadhaarDigits.map((digit, idx) => (
                    <div
                      key={idx}
                      className={`w-[32px] h-[34px] border-2 border-black flex items-center justify-center font-mono font-black text-[16px] bg-white ${
                        idx === 3 || idx === 7 ? "mr-3 border-r-2" : "-mr-[2px]"
                      }`}
                    >
                      {digit.trim()}
                    </div>
              ...
              <div className="grid grid-cols-12 gap-4 mt-1.5 items-center">
                <div className="col-span-3 flex items-center gap-1.5">
                  ...
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-black text-[13px] bg-white">
              ...
              <div className="mt-1.5 flex items-baseline gap-2">
                ...
                <div className="flex-1 border-b-2 border-dotted border-black pb-0.5 font-bold text-[13px] min-h-[24px]">
            ...
            <div className="pt-1">
              ...
              <div className="grid grid-cols-12 gap-3 items-center">
                <div className="col-span-3 flex items-center gap-1.5">
                  <span className="font-bold text-[12.5px] shrink-0">1. Present Class*:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-black text-[13px] bg-white">
                    {data.educationalInfo.presentClass || ""}
                  </div>
                </div>
                <div className="col-span-3 flex items-center gap-1.5">
                  <span className="font-bold text-[12.5px] shrink-0">2. Section*:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-black text-[13px] bg-white">
                    {data.educationalInfo.presentSection || ""}
                  </div>
                </div>
                <div className="col-span-3 flex items-center gap-1.5">
                  <span className="font-bold text-[12.5px] shrink-0">3. Roll No:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-black font-mono text-[13px] bg-white">
                    {data.educationalInfo.presentRoll || ""}
                  </div>
                </div>
                <div className="col-span-3 flex items-center gap-1.5">
                  <span className="font-bold text-[12.5px] shrink-0">4. Stream:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-bold text-[12.5px] bg-white">
              ...
              <div className="grid grid-cols-12 gap-3 mt-1.5 items-center">
                <div className="col-span-3 flex items-center gap-1.5">
                  <span className="font-bold text-[12.5px] shrink-0">5. Previous Class*:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-black text-[13px] bg-white">
                    {data.educationalInfo.previousClass || ""}
                  </div>
                </div>
                <div className="col-span-3 flex items-center gap-1.5">
                  <span className="font-bold text-[12.5px] shrink-0">6. Section*:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-black text-[13px] bg-white">
                    {data.educationalInfo.previousSection || ""}
                  </div>
                </div>
                <div className="col-span-3 flex items-center gap-1.5">
                  <span className="font-bold text-[12.5px] shrink-0">7. Roll No:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-black font-mono text-[13px] bg-white">
                    {data.educationalInfo.previousRoll || ""}
                  </div>
                </div>
                <div className="col-span-3 flex items-center gap-1.5">
                  <span className="font-bold text-[12.5px] shrink-0">8. Stream:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-2 flex items-center justify-center font-bold text-[12.5px] bg-white">
              ...
              <div className="grid grid-cols-12 gap-4 mt-1.5 items-center">
                <div className="col-span-5 flex items-center gap-2">
                  <span className="font-bold text-[12.5px] shrink-0">9. Medium*:</span>
                  <div className="flex-1 h-[34px] border-2 border-black px-3 flex items-center font-bold text-[13px] bg-white">
                    {data.educationalInfo.medium || ""}
                  </div>
                </div>
                <div className="col-span-7 flex items-center gap-2">
                  <span className="font-bold text-[12.5px] shrink-0">10. No of days child attend school:</span>
                  <div className="w-36 h-[34px] border-2 border-black px-2 flex items-center justify-center font-black font-mono text-[13.5px] bg-white">
            ...
            <div className="pt-1">
              ...
              <div className="grid grid-cols-2 gap-6 mt-1.5 items-baseline">
                <div className="flex items-baseline gap-2">
              ...
              <div className="grid grid-cols-2 gap-6 mt-1.5 items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-48 h-[34px] border-2 border-black px-2.5 flex items-center justify-center font-mono font-black text-[14px] tracking-wider bg-white">
              ...
              <div className="mt-1.5 flex items-center gap-2">
                ...
                <div className="w-96 h-[34px] border-2 border-black px-3 flex items-center font-mono font-black text-[14px] tracking-wider bg-white">
      ...
      {(activePage === "all" || activePage === "page2") && (
        <div
          ...
          className={cn(
            "admission-sheet relative bg-white mx-auto box-border flex flex-col justify-between border-2 border-black overflow-hidden",
            !isLastInBatch ? "page-break-after-sheet" : "no-page-break-after"
          )}
          style={{
            width: "205mm",
            minHeight: "291mm",
            ...
            margin: "2.5mm auto",
            padding: "3.5mm 4.5mm",
            pageBreakAfter: !isLastInBatch ? "always" : "auto",
            breakAfter: !isLastInBatch ? "page" : "auto",
            pageBreakInside: "avoid",
            breakInside: "avoid",
          }}
        >
          ...
          <div className="w-full space-y-2.5 text-[12.5px] relative z-10">
            {/* 10. Email */}
            ...
            <div className="pt-0.5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-96 h-[34px] border-2 border-black px-3 flex items-center font-mono font-black text-[14px] uppercase tracking-wider bg-white">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-[420px] h-[34px] border-2 border-black px-3 flex items-center font-mono font-black text-[14px] tracking-wider bg-white">
            ...
            <div className="pt-0.5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <div className="flex-1 border-b-2 border-dotted border-black pb-0.5 font-black text-[13.5px] uppercase min-h-[22px]">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <div className="flex-1 border-b-2 border-dotted border-black pb-0.5 font-bold text-[13.5px] min-h-[22px]">
                ...
                {/* 7. Relationship */}
                <div className="flex items-baseline gap-2">
                  <span className="font-bold text-[12.5px] w-[230px] shrink-0">
                ...
                <div className="grid grid-cols-2 gap-6 items-center pt-0.5">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-[12.5px] shrink-0">8. Annual Family Income:</span>
                    <div className="w-48 h-[34px] border-2 border-black px-2.5 flex items-center font-black text-[13px] bg-white">
                      {data.guardianDetails.annualIncome || ""}
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-[12.5px] shrink-0">9. Guardian's Qualification:</span>
                    <div className="w-56 h-[34px] border-2 border-black px-2.5 flex items-center font-bold text-[12.5px] bg-white">
            ...
            <div className="pt-0.5">
              ...
              {/* 3. District & 4. Block/Municipality */}
              <div className="grid grid-cols-2 gap-6 mt-1 items-baseline">
                <div className="flex items-baseline gap-2">
                  <span className="font-bold text-[12.5px] shrink-0">3. District :</span>
                  <div className="flex-1 border-b-2 border-dotted border-black pb-0.5 font-bold text-[13px] min-h-[22px]">
              ...
              {/* 7. Police Station & 8. Pin Code */}
              <div className="grid grid-cols-2 gap-6 mt-1 items-center">
                <div className="flex items-baseline gap-2">
                  <span className="font-bold text-[12.5px] shrink-0">7. Police Station*:</span>
                  <div className="flex-1 border-b-2 border-dotted border-black pb-0.5 font-bold text-[13px] min-h-[22px]">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <div className="w-72 h-[34px] border-2 border-black px-3 flex items-center font-bold text-[13px] bg-white">
          ...
          {/* Signatures Footer */}
          <div className="w-full mt-auto pt-5 pb-1">
            <div className="grid grid-cols-3 gap-8 text-center items-end">
              <div className="flex flex-col items-center">
                <div className="w-56 border-t-2 border-black pt-1.5 font-black text-[13px] tracking-wide uppercase">
                  Approved by
                </div>
              </div>
            ...
            <div className="w-full text-right text-[11px] text-gray-800 pt-1.5 mt-2 border-t border-gray-400 font-bold">
              Page 2 of 2 (Back)
            </div>
          </div>
        </div>
