          ...
          <div className="w-full relative z-10">
            ...
            <div className="flex items-stretch justify-between gap-4 mb-2.5">
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center px-2">
                ...
                <h3 className="text-[17px] font-black uppercase tracking-wider text-black mt-2 underline decoration-2 underline-offset-4">
                  Application Form
                </h3>
              </div>
            ...
            <div className="pt-0.5">
              ...
              <div className="grid grid-cols-12 gap-2.5 items-center">
                ...
                <div className="col-span-3 flex items-center gap-1.5">
                  ...
                  <div className="flex-1 h-8 border-2 border-black px-1.5 flex items-center justify-center font-black font-mono text-[12.5px] bg-white">
                    {data.educationalInfo.presentRoll || ""}
                  </div>
                </div>
                <div className="col-span-3 flex items-center gap-1.5">
                  <span className="font-bold text-[12.5px] shrink-0">4. Stream:</span>
                  <div className="flex-1 h-8 border-2 border-black px-1.5 flex items-center justify-center font-bold text-[12.5px] bg-white">
              ...
              <div className="grid grid-cols-12 gap-3 mt-1.5 items-center">
                ...
                <div className="col-span-7 flex items-center gap-2">
                  ...
                  <div className="w-28 h-8 border-2 border-black px-2 flex items-center justify-center font-black font-mono text-[13px] bg-white">
