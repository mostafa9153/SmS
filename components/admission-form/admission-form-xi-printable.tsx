      ...
      {(activePage === "all" || activePage === "page1") && (
        ...
        >
          ...
          <div className="w-full">
            ...
            <div className="relative mt-2 mb-2 min-h-[90px] flex items-center justify-center">
              {/* Photo Box (Left) */}
              ...
              <div className="absolute right-0 top-0 w-[42mm] border-2 border-black p-1.5 text-[10px] leading-[17px] bg-gray-50/20">
                <div className="font-bold text-[10.5px] text-center border-b border-black pb-0.5 mb-1">
                  For Office Use
                </div>
                <div className="flex justify-between">
                  <span>D.O.A. -</span>
                  <span className="font-bold">{data.officeUse.doa || ""}</span>
                </div>
                <div className="flex justify-between">
                  <span>SL No –</span>
                ...
                <div className="flex justify-between">
                  <span>Class –</span>
                  <span className="font-bold">{data.officeUse.class || "XI"}</span>
                </div>
                <div className="flex justify-between">
                  <span>Sec. -</span>
          ...
          {/* Body Section */}
          <div className="w-full space-y-2 mt-3 text-[11px]">
            {/* A. Basic Information */}
            <div>
            ...
            <div className="pt-1">
              ...
              <div className="flex items-baseline gap-2 mb-2">
                <span className="font-bold shrink-0">1. School Name :</span>
                <div className="flex-1 border-b border-dotted border-black pb-0.5 font-medium min-h-[18px]">
                  {data.educationalInfo.previousSchoolName || ""}
                </div>
              </div>

              {/* Marks Obtained, Percentage & Subject breakdown */}
              <div className="grid grid-cols-12 gap-2 items-center mb-1.5">
                <div className="col-span-6 flex items-baseline gap-1.5">
                  <span className="font-bold shrink-0">2. Marks Obtained :</span>
                  <div className="flex-1 border-b border-dotted border-black pb-0.5 font-bold text-[11px] min-h-[18px]">
                    {data.educationalInfo.marksObtained || ""}
                  </div>
                </div>
                <div className="col-span-6 flex items-baseline gap-1.5">
                  <span className="font-bold shrink-0">3. Percentage :</span>
                  <div className="flex-1 border-b border-dotted border-black pb-0.5 font-bold text-[11px] min-h-[18px]">
              ...
              <div className="grid grid-cols-7 gap-1.5 items-center pt-0.5">
                {/* 4. Beng */}
                <div className="border border-black/70 p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[10px] font-bold text-gray-700">4. Beng.</span>
                  <div className="h-5 flex items-center justify-center font-bold text-[11px]">
                ...
                {/* 5. Eng */}
                <div className="border border-black/70 p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[10px] font-bold text-gray-700">5. Eng.</span>
                  <div className="h-5 flex items-center justify-center font-bold text-[11px]">
                ...
                {/* 6. Math */}
                <div className="border border-black/70 p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[10px] font-bold text-gray-700">6. Math.</span>
                  <div className="h-5 flex items-center justify-center font-bold text-[11px]">
                ...
                {/* 7. L. Sc. */}
                <div className="border border-black/70 p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[10px] font-bold text-gray-700">7. L. Sc.</span>
                  <div className="h-5 flex items-center justify-center font-bold text-[11px]">
                ...
                {/* 8. P. Sc. */}
                <div className="border border-black/70 p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[10px] font-bold text-gray-700">8. P. Sc.</span>
                  <div className="h-5 flex items-center justify-center font-bold text-[11px]">
                ...
                {/* 9. Hist */}
                <div className="border border-black/70 p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[10px] font-bold text-gray-700">9. Hist.</span>
                  <div className="h-5 flex items-center justify-center font-bold text-[11px]">
                ...
                {/* 10. Geo */}
                <div className="border border-black/70 p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[10px] font-bold text-gray-700">10. Geo.</span>
                  <div className="h-5 flex items-center justify-center font-bold text-[11px]">
