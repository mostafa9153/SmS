          ...
          <div className="w-full space-y-3 text-[12.5px]">
            ...
            <div className="pt-1">
              ...
              <div className="flex items-baseline gap-2 mb-1.5">
                ...
                <div className="flex-1 border-b-2 border-dotted border-black pb-0.5 font-black text-[13px] min-h-[24px]">
                  {data.educationalInfo.previousSchoolName || ""}
                </div>
              </div>

              {/* Marks Obtained & Percentage */}
              <div className="grid grid-cols-2 gap-6 items-center mb-1.5">
                <div className="flex items-baseline gap-2">
                  <span className="font-bold text-[12.5px] shrink-0">2. Marks Obtained :</span>
                  <div className="flex-1 border-b-2 border-dotted border-black pb-0.5 font-black font-mono text-[13.5px] min-h-[24px]">
              ...
              <div className="grid grid-cols-7 gap-2 items-center pt-0.5">
                {/* 4. Beng */}
                <div className="border-2 border-black p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[12px] font-black text-black">4. Beng.</span>
                  <div className="h-8 flex items-center justify-center font-black font-mono text-[14px] bg-white mt-0.5">
                ...
                {/* 5. Eng */}
                <div className="border-2 border-black p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[12px] font-black text-black">5. Eng.</span>
                  <div className="h-8 flex items-center justify-center font-black font-mono text-[14px] bg-white mt-0.5">
                ...
                {/* 6. Math */}
                <div className="border-2 border-black p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[12px] font-black text-black">6. Math.</span>
                  <div className="h-8 flex items-center justify-center font-black font-mono text-[14px] bg-white mt-0.5">
                ...
                {/* 7. L. Sc. */}
                <div className="border-2 border-black p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[12px] font-black text-black">7. L. Sc.</span>
                  <div className="h-8 flex items-center justify-center font-black font-mono text-[14px] bg-white mt-0.5">
                ...
                {/* 8. P. Sc. */}
                <div className="border-2 border-black p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[12px] font-black text-black">8. P. Sc.</span>
                  <div className="h-8 flex items-center justify-center font-black font-mono text-[14px] bg-white mt-0.5">
                ...
                {/* 9. Hist */}
                <div className="border-2 border-black p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[12px] font-black text-black">9. Hist.</span>
                  <div className="h-8 flex items-center justify-center font-black font-mono text-[14px] bg-white mt-0.5">
                ...
                {/* 10. Geo */}
                <div className="border-2 border-black p-1 text-center bg-gray-50/40 rounded-xs">
                  <span className="block text-[12px] font-black text-black">10. Geo.</span>
                  <div className="h-8 flex items-center justify-center font-black font-mono text-[14px] bg-white mt-0.5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-6 items-center pt-0.5">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="w-48 h-[34px] border-2 border-black px-3 flex items-center font-black text-[13px] bg-white">
