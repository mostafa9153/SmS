      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold tracking-tight">Results & Marks Management</h1>
        ...
        <div className="flex items-center gap-2">
          {isBatchMode ? (
            <button
              ...
              className="flex items-center gap-1.5 rounded-md bg-primary px-3.5 py-1.5 text-xs font-semibold text-primary-foreground hover:bg-primary/90 transition-colors shadow-sm animate-pulse"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-md bg-amber-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-amber-700 transition-colors shadow-sm"
            >
              <Sparkles className="h-3.5 w-3.5" />
              ⚡ Quick Batch Marks Entry
            </button>
          )}
          ...
          {isBatchMode && (
            <button
              ...
              className="rounded-md border bg-background px-2.5 py-1.5 text-xs font-medium hover:bg-muted"
            >
              Cancel
            </button>
          )}
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-md border bg-card px-3 py-1.5 text-xs font-medium hover:bg-muted transition-colors shadow-sm"
          >
          ...
          <a
            ...
            className="flex items-center gap-1.5 rounded-md border border-primary/30 bg-primary/5 px-3 py-1.5 text-xs font-semibold text-primary hover:bg-primary/10 transition-colors shadow-xs"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-md bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-emerald-700 transition-colors shadow-sm disabled:opacity-50"
          >
